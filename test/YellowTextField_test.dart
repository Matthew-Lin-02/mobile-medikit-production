...
void main() {
  testWidgets('StressfulEventsTextField shows default hint text',
  ...
  testWidgets('StressfulEventsTextField shows custom hint text',
      (WidgetTester tester) async {
  ...
  testWidgets('StressfulEventsTextField has correct maxLines and styling',
      (WidgetTester tester) async {
    // Build the widget
    await tester.pumpWidget(
      const MaterialApp(
  ...
  testWidgets('StressfulEventsTextField renders with specified border',
      (WidgetTester tester) async {
    // Build the widget
    await tester.pumpWidget(
      const MaterialApp(
