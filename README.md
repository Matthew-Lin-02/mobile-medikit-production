...
New pages and their components are developed on branches and merged through pull requests, each of which requires a user review.
Each addition to the codebase should use defined constants and include tests for the new components.
A pull request requires images of the new features (when applicable) and a short description of the changes.
